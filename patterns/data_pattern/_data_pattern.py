pattern = {
    ...
    'vacancy': {
        ...
        'mex': ("ФИО", "my name", " готовим IT-специалистов", "ответы с собеседований",
                ...
                '[Мм]енеджер по снабжению', '@forgamedev', '@forhr', '[Бб]ухгалтер по заработной плате', 'Музейный работник',
                'Экскурсовод', 'Ассистент', '[Jj]unior[Ll]awyer', '[Пп]роизводственный стажер', 'налогового консульт', '[Сс]омелье',
                'в функцию снабжения', 'Менеджер по грузоперевозк', '[Шш]иномонтаж', '[Пп]арикмахер', '[Rr]eceptionest','в департамент аудита',
                'втомобильная логистика', 'по буровым растворам', 'руппа административной поддержки', 'ссистент директора',
                'промо выкладк', 'в административно-хозяйственный отдел', 'отдела документооборот', 'отдел документооборот',
                'одитель международных перевозок', '[Пп]лотник', '[Аа]рт[- ][Дд]иректор', 'Трейдер-стажер', 'Office Assistant',
                'Кинолог-стажёр', '[Сс]таж[её]р службы по поставкам', 'Intern Supply Chain', 'Стажер в редакцию', 'гистолог',
                '[Сс]таж[её]р в отдел экспорта', 'Производственный стажер', 'в отдел обучения', '[Сс]таж[её]р отдела международных стандартов финансовой отчетности',
                '[Сс]таж[её]р - мастер', '[Сс]таж[её]р отдела документооборота', '[Сс]таж[её]р-мастер', 'департамента закупок',
                'Закупка материалов', 'Специалист по сверке', '[Сс]таж[её]р, отдел бухгалтерия', 'команду корпоративной культуры',
                'команду инвестиционного консультирования', 'команду управления рисками','Personal Injury Solicitor', '[ ,-][Гг]рузчик[., ]',
                '[Сс]лесарь', '[Ээ]лектромонтажник', '[Пп]ортной', 'в области маркировки', '[Аа]рхитектурное бюро', 'специалист по документообороту',
                '[Сс]таж[её]р (инженера-технолога)', '[Ээ]кономист-стаж[её]р', '[Сс]таж[её]р юридической фирмы', '[Сс]таж[её]р [Фф]инансы',
                '[Сс]таж[её]р в инженерный отдел', '[Сс]таж[её]р-[Бб]ариста', 'в команду судебного взыскания', 'в отдел продаж готового жилья',
                '[Сс]таж[её]р инженера-технолога', 'по работе с аптечными сетями', '[Tt]reasury [Ss]pecialist', '[Тт]рейдер-[Сс]таж[её]р',
                'TV Buyer', 'менеджер по размещению рекламных кампаний на ТВ', '[Сс]таж[её]р Отдела налогового учета и отчётности',
                '[Сс]таж[её]р Отдела оптимизации и управления документооборотом', '[Сс]таж[её]р отдела финансового контроля',
                'Водитель СЕ', 'Водитель CE', 'Legal intern', '[Сс]таж[её]р - стажер', '[Сс]таж[её]р в автосервис', '[Пп]роизводственный [Сс]таж[её]р',
                '[Сс]таж[её]р-экономист', 'с первичной документ', 'Помощник в офис', 'в отдел ценообразования', 'в отдел по строительству',
                'в отдел финансирования', '[Cc]ategory [Mm]anager', 'Закупка материалов', 'Выдача заказов,', 'Сортировка товаров',
                'омощь в организации документооборот', 'енеджер по грузоперевозкам', '[Сс]таж[еёо]р в Юридическое управление',
                'образцами лекарственных средств', 'проведение судебных экспертиз', '[Сс]таж[еёо]р fashion направления',
                '[Лл]огист-[Сс]таж[еёо]р', 'забивке мини свай', '[Кк]ондитер в', '[Кк]ондитеров-новичков', 'инженер дефектоскопист',
                'по ведению нормативно-справочной информации', 'инженер-электрик', 'Сотрудник склада', 'по буровым растворам',
                'Управляющий сетью салонов', '[Сс]таж[еёо]р-электрик', '[Юю]рист со знанием', '[Пп]оручени[ейя] бухгалтер',
                'менеджер по аренде', 'в отдел подач ', '[Сс]канирование документов', '[Пп]ожарной безопасности',
                '[Оо]казани[еяю] услуг в области корпоративного налогообл[оа]жени', '[Рр]иелтор[ -/][Сс]таж[еёо]р',
                '[Сс]таж[еёо]р fashion', '[Пп]отребительских тестов', 'Кладовщик', 'отрудник барно-кассовой зон',
                '[Кк]ондитер', '[Пп]окерного клуб', '[Ee]vent assistant', '[Ee]vent specialist', '[Лл]огист-[Сс]таж[еёо]р',
                '[Рр]азъездн', '[Кк]уратор онлайн-школ', '[Пп]ересчет товара', '[Ll]egal [Cc]orporate [Ee]xecutive ',
                '[Jj]unior [Ll]awyer', '[Хх]имик-[Сс]таж[еёо]р', 'for [Tt]ax [Dd]epartment', '[Сс]таж[еёо]р на госзакупки',
                '[Ии]нвестиционный менеджер', '[Сс]екретарь', '[Оо]фис менеджер','Менеджер по запуску ресторанов',
                '[Мм]аляр', '[Шш]тукатур', '[Сс]толяр', 'замена ламп', 'строительных работ', 'мелкий ремонт', '[Сс]антехник',
                '[Оо]бслуживанию зданий', 'тестосмесительной', 'варка сиропа', 'сан.кни[гж]', '[Ee]vent[ -][Мм]енеджер',
                'по работе с претензиями', 'по рекламациям', '[Фф]инансовый менеджер','монитор клинических исследований',
                'Трейдер-стажер', 'Менеджер по продажам логистических услуг', '[Ээ]лектропоезд', 'в отдел оптики',
                'показов недвижимости', '[Кк]нижного магазина', ' (https://t.me/it_jobs_agregator/42196)[Мм]ладший бухгалтер',
                '[Фф]инансовый менеджер', '[Бб]етонщик', 'Бухгалтер по заработной плате', 'Инспектор по двору', '[Дд]осмотр пассажиров',
                '[Пр]роверка багажа', 'Менеджер АХО', '[Дд]иректор-стаж[еёо]р', '[Уу]правлявшего розничной', '[Уу]ченик бухгалтера',
                'Оператор игровой зоны', 'Специалист по сертификации', '[Дд]иректор [Мм]агазина', '[Бб]ухгалтер по ра[с,сс]ч[её]ту',
                '[Ии]нструктор ЛФК', '[Пп]екар[ья][ ,.-]', 'специалист банка', 'по собственному производству', 'регионального управляющего',
                '[Оо]ператор [Фф]лота', 'сухогрузного флот', 'отдела продаж автомобилей', 'ссистент бьюти', 'чистоты в зале',
                'мастеров ногтевого сервиса', 'мастера ногтевого сервиса', 'продаж логистических услуг', 'Pharmacist',
                'Младший бухгалтер', 'Диспетчер аварийной службы', 'Бизнес-тренер', 'Бухгалтер по расчету заработной платы',
                'ОВиВК', 'Водитель погрузчика', 'Буфетчик', 'фотографировать детей', '[Мм]ладшая [Мм]едсестра', '[Мм]ладший [Мм]едбрат',
                'в отдел международной логистики', 'в отдел сертификации', '[Сс]ервисный инженер', 'по связям с общественностью',
                '[Сс]таж[оеё]р[ -]авиамеханик', 'Финансовый контролер', 'Бухгалтер по заработной плате', 'Tax Specialist',
                'подготовке налоговых деклараций', 'Химик'
                ),
...
#     # capitize
    ...
    'junior': {
        ...
        'mex': ("не готовы рассматривать", "джуниоров пока не рассматриваем","Junior не рассматриваем",
                ...
                "[Лл]ичный помощник", "[Бб]изнес[-\s]ассистент", "[Мм]енеджер по туризму", "От [2345][+х] лет", 'автор курса',
                '[Сс]таж[её]р в подразделение [Зз]акупки', '2 year', 'ищем старшего инженера', 'junior school', '[Дд]иректор магазина',
                'Заместитель руководителя отдела QA', 'не менее 3-х лет', 'Тренер по продажам'
                ),
        'mex2': (),
        'mincl': ()
    },
