...
async def fullstack_specialization_callback(
    query: CallbackQuery, state: FSMContext
) -> None:
    """Обработка callback для fullstack направления"""
