...
from _apps.ask_gpt.bot.variables import chat_gpt_sales_manager, chat_gpt_without_history, chat_gpt_set_prompt, \
    watch_prompt, tokens_number, watch_tokens_number
