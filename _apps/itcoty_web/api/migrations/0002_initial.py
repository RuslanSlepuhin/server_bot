# Generated by Django 4.2.11 on 2024-09-26 19:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qualification', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('trainee', 'Trainee'), ('junior', 'Junior'), ('middle', 'Middle'), ('senior', 'Senior'), ('lead', 'Lead'), ('director', 'Director')], max_length=128), blank=True, null=True, size=None)),
                ...
                ('job_format', models.CharField(blank=True, choices=[('удалённая', 'Remote'), ('офис', 'Office'), ('гибкий график', 'Hybrid')], max_length=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('vacancy', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.vacancy')),
            ],
        ),
        migrations.CreateModel(
            name='Qa',
