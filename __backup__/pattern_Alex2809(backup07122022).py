pattern = {
    ...
    'frontend': {
        ...
        'mex': ("React as a plus", "understanding of front-end", "взаимодействие с отделом frontend", "QA Automation",
                ...
                "Position:IT Recruiter", "Senior C\\+\\+", "C++", "С++", "Senior C++", "Senior C\\+\\+",
                ...
                "Crystal/Ruby full-stack developer",
                "Должность: Manual QA", "Web-дизайнер (UI/UX) middle", "Laravel", 'Senior Java developer',
                "Backend-разработчик", "Senior Golang",
                "Product designer", "Go developer", "JAVA backend", "SRE-инженер", "Python Developer",
                "Blockchain Developer",
                "Java developer (middle, senior)", "Java developer (senior)", "Senior Java engineer",
                "Java разработчика",
                "Senior Java developer", "JAVA разработчик", "#backend", "Java Developer", "#QA", "Ruby on Rails",
                "DevOps",
                "Вакансия: Java Software Developer", "Ruby full-stack developer", "HCM", "на позицию DevOps",
                "Senior backend",
                "Тестировщик", "Вакансия: QA Инженер", "Frontend engineer", "Senior Frontend developer",
                "Junior Manual QA", "Golang", "#QA",
                "#AutomationQA", "Test Automation Engineer", "Java developer", "Java Team Lead", "Team Lead(Java)",
                "QA auto", "AQA"
                           "Java developer (senior)", "Java Developer (middle)", "Senior Devops", "Web-developer",
                "Веб-программист",
                " .NET", "C#", "React developer", "Business Development Manager", "Senior Java developer",
                " Java-разработчик",
                "Junior project manager", "Нужен:  Дизайнер", "Бизнес-аналитик", "System Analyst",
                "Специалист по маркетингу", "Консультант",
                "Программист 1С", "Разработчик Node.js", "Web Content Manager", "Инженер по развитию",
                "Sales Assistant", "React Native Developer",
                "AQA", "Менеджер по продукту", "разработчика React Native", "Менеджер по запуску производства",
                "IOS Developer",
                "Дизайнер упаковки", "графический дизайнер", "Графический дизайнер", "Senior React Native",
                "React Native разработчик",
                "JAVA Liferay", "Customer Support Specialist", "Android Developer", "приложений React Native",
                "Team Lead PHP", "UX/UI Дизайнер",
                "Архитектор воронок", "Маркетолог по воронкам", "backend developer", "консультант", "Product Owner",
                "Business Analyst",
                "Scala", "AWS", "#Java ", "#Java,", "контекстной рекламе", "CRM-аналитик", "менеджер по продажам",
                "sales manager",
                "Junior Project Manager", "Копирайтер", "копирайтер", "Business Development", "маркетолог",
                "Маркетолог", "Junior IT рекрутер", "Analyst ",
                "Product Manager", "Growth Product Manager", "Product manager", "Менеджер по продажам", "SMM-менеджер",
                "Android Middle разработчик",
                "Руководитель отдела продукта", "PR IT", "PHP-программист", "специалист технической поддержки",
                "Менеджер по продажам",
                "Интернет-маркетолог", "middle Android developer", "Младший аналитик", " accountant", " #financier",
                "аналитик",
                "Аналитик", "по работе с клиентами", "React Native Developer", "BackEnd Java-разработчик",
                "Retention Spesialist",
                "проектировщик сетей связи", "Project Manager", "юрист", "системный аналитик", "Системный аналитик",
                "Python (Mıddle)",
                "Трафик-менеджер", "контекстная реклама", "Художник - дизайнер", "иллюстратор",
                "Разработчик Python (Junior)",
                "Веб-дизайнер", "Graphic Designer", "Таргетолог", "оптовым продажам", "керамист",
                "Оператор call-центра",
                "Lead Generation", "Junior Backend Developer", "Customer Support Specialist", "Data Engineer",
                "iOS Developer",
                "разработчик ML", "spine animator", "администрирования выплат", "Elixir", "аналитик", "продюсер",
                "java-разработчик",
                "Java Tech Lead", "Разработчик Java (Senior)", "Менеджер по продаже", "Embedded developer",
                "Менеджер WB",
                "Менеджер по маркетплейсам", "исследователь", "исследователя", "журналист", "менеджер в",
                "бизнес-ассистент",
                "руководитель CRM", "Product Analyst", "Менеджер по развитию интернет проектов", "Media Buyer",
                "Дата-аналитик",
                "SEO-специалист", "Менеджер по контенту", "Онлайн-менчендайзер", "Руководитель отдела продаж",
                "SEO специалист",
                "Медиапланер", "Linkbuilder", "marketing manager", "мебели", "Artist", "Арт-директор",
                "контент-менеджер", "Producer",
                "редактор", "Tech writer", "UE4 Developer", "специалист по обработке данных", "ресерчер",
                "специалист по подбору персонала",
                "куратор по маркетингу", "системный администратор", "эникей", "ТЗ-мейкер", "Мобильный разработчик",
                "Flutter",
    ...
    'backend': {
        'ma': (
        "Ruby", "PHP", " .NET", "NodeJS", "Python Engineer", "#ML ", "машинному обучению", "MLOps", "ML engineer",
        ...
        'mex': ("DevSecOps", " UI/UX designer", "@python_job_interview", "Data Engineer", "backend разработчиками",
                ...
                "#devops", "product lead", "Ищем Frontend developer", "#resume", "UI Designer", "Designer",
                "UI designer",
                "Technical writer ", "Senior Frontend Developer", "Разработчик JS", "React Frontend developer",
                "Вакансия: Frontend engineer",
                "разработчик на React Native", "Ведущий тестировщик", "AQA", "Senior Devops",
                "Администратор баз данных", "Javascript developer",
                "консультант техподдержки", "Вакансия: Frontend ", "Вакансия:  Frontend Developer",
                "Senior Frontend Developer",
                "Front-end разработчик", " Frontend Software Engineer", "#QA", "Test Automation Engineer", "QA Auto",
                "Junior JavaScript разработчик", "Network Engineer", "#kotlin", "Network administration",
                "Network architect", "React Native",
                "Junior Manual QA", "Lead Frontend Developer", "Node.js", "Mobile Development")
    },

    'python': {
        'ma': ("Senior Python developer", "Python Engineer", "#ML ", "машинному обучению", "MLOps", "ML engineer",
    ...
    'mobile': {
        ...
        'mex': ("Python", "T-Mobile", "Swift, is a nice to have skill", "QA Automation", "QA Auto",
                ...
                "Product Designer", "share_ios", "Content Designer", "Linux Embedded Developer",
    ...
    'designer': {
        ...
        'mex': ("дизайнеры", "Artec 3D", "3D scanners", "DevOps", "Web UI", "Product manager", "Product owner",
                ...
                "Understanding UI state", "Material UI", "до UI", "Python", "#Java", "JavaScript", "Kotlin", "Swift",
                "Git ", "Git,", "Git.", " C ",
                "C\\+\\+", "C#", "ObjectiveC", "React", "SoapUI", "Postman", "POSTMAN", "PostgreSQL", "MySQL",
                "iOS разработчик", "Full Stack",
                "fullstack Web Developer", "Flutter Developer", "Senior Dealer", "Инженер-электронщик", "NodeJS", "Vue",
                "VueRouter", "Vuex",
                ...
                "Android-разработчик", "Продакт-менеджер", "Аналитик DWH", "Delphi", "Business Analyst", "#automation",
                "#selenium", "автотесты", "автотестов", "cucumber",
                "QA Engineer", "Angular", "bitrix", "битрикс", "менеджера по продажам", "менеджер по продажам",
                "специалист по тестированию",
                "Soap", "postman", "тестировщик", "json", "JSON", "Администратор", "администратор", "баз данных",
                "базы данных", "Баз данных",
                "Базы данных", "HRD", "Консультант SAP", "Content Manager", "ремонтов квартир", "Ведущий аналитик",
                "Специалист по контенту",
                "запуск производства", "керамист", "Руководитель отдела маркетинга", "мебели", "мебельного",
                "мужской одежды",
                "детской одежды", "Business Development", "Data acquisition manager", "футболки", "кофров", "чехлов",
                "Проектировщик", "интерьеров", "Менеджер по продажам", "Marketing Specialist", "квартир",
                "СММ Менеджер",
                "Проджект менеджер", "project manager", "интерьера", "ремонта квартир", "Менеджер по маркетплейсам"
                                                                                        "SMM-специалист",
                "Интернет-маркетолог", "Менеджер по продажам", "SMM-маркетолог", "SMM-менеджер",
                ...
                "Сметчик", "Media Buyer", "Product Manager", "Арбитражник", "Медиабайер",
                "Заместитель директора по маркетингу",
                "Email маркетолог", "CRM маркетолог", "Email-маркетолог", "CRM-маркетолог", "Data Analyst",
    ...
    'hr': {
        ...
        'mex': ("Скрининг с HR", "я HR", "представляю кадровое агентство", "Общение с HR", "общение с HR", "HR_",
                ...
                "пишите в телеграмм нашему HR", "пишите нашему HR", "Mobile QA", "Front-end инженер",
                "Программиста игровой логики",
    ...
    'analyst': {
        ...
        'mex': ("Business Analyst", "/BA", " BA", "бизнес аналитик", " ВА", "business analyst", "Бизнес аналитик",
                ...
                "Вакансия: Менеджер по продукту", "Backend Engineer", "Frontend Engineer", "Manual QA",
    ...
    'qa': {
        ...
        'mex': ("тестировщиков", "тестировщиками", "проводить QA", " и QA", "to junior", "PHP Developer",
                ...
                "#nodejs", "Senior it recruiter", "Вакансия: iOS developer", "Vue разработчик",
    ...
    'devops': {
        'ma': ("DevSecOps", "инженера по информационной безопасности", "DevOps", "SRE", "Site Reliability Engineer",
               ...
               "Network architect", "Systems Engineer", "Системного администратора", "Системный администратор",
        ...
        'mex': (" и SRE", ", DevOps,", "DevOps командой", "участвовать в DevOps", "Опыт DevOps", "участвуют в DevOps",
                ...
                "Django", "Middle QA", "Mobile manual QA", "SeniorQA", "QA Automation (Python)", "По тестированию",
                "Участвуют в devops",
                "Участвовать в devops", "Участие в devops", "Copywriter", "Senior ux/ui", "Senior ui/ui",
                "Ruby разработчик",
                "Системный аналитик", "Senior python", "Ios разработчик", "Ios developer", "Middle ios", "Junior ios",
                "Senior ios",
                "QA Automation", "Sales Enablement Specialist", "Backend-разработчика", "Project manager",
                "тестовые окружения",
                "ручное тестирование", "специалистов по тестированию", "Менеджер проектов", "Проект-менеджер", "Artist",
                "Scala Developer",
                "MLOps", "autoML", "Business Intelligence", "AQA", "Machine learning developer", "Тех.лид",
                "Xamarin Developer", "IT рекрутер",
                "Middle BackEnd")
    },
    ...
    'marketing': {
        ...
        'mex': (
        "SEO HR", "Product manager", "SEO HR", "HRBP", "Sales Manager", "Manual QA", "Product Manager", "Back-end",
        "Kotlin Developer",
        "Middle Business Analyst", "PHP Developer", "DevOps", "C# Developer", "Lead Business Analyst", "Data Scientist",
        "System Administrator",
        "Project manager", "ищет веб-дизайнер", "ищем веб-дизайнер", "Product Owner", "CEO", "Lead Generation",
        "IT-specialist",
        "Front-end", "Product designer", "Менеджер проектов", "Проект-менеджер", "Full stack", "Level Designer",
        "Artist", "Креативный продюсер",
    ...
    'sales_manager': {
        'ma': ("Sales manager", "sales manager", "Sales Manager", "Менеджера по продажам", "Менеджер холодных продаж",
               "Менеджер по продажам", "менеджер_отдела_продаж", "Lead Generation", "IT Sales Researcher",
               "#leadgeneration", "User Acquisition",
               "линкбилдинг", "linkbuilder", "Link Builder", "CRO", "Sales Researcher"),
        'mex': (
        "Python-разработчика", "Системного администратора", "NodeJS Developer", "Project Manager", " DevOps Engineer")
    },
    ...
    'junior': {
        ...
        'mex': ("не готовы рассматривать", "джуниоров пока не рассматриваем", "Junior не рассматриваем",
                ...
                "джуниоров не смотрим",
                "от 2-х лет", "от двух лет", "от 2х лет", "от 2 лет", "3+ years of experience",
                "2+ years of experience",
                "Не менее 2-3 лет работы", " от 3 лет", "от 3-х лет", "не менее 3 лет", "Senior product",
                "Senior Product", "senior product",
                "2 года", "Менторить младших разработчиков", "Senior Javascript", "3+ years of experience",
                "Senior Gameplay",
